...
\titulo{Uma Abordagem Experimental para Avaliação de Fardamentos: Um Estudo Aplicado à Busca Terrestre} %Título do trabalho
...
\adicionarMembro{\posto{CAP}}{Wagner Alberto de Moraes}{CBMSC} %membro da banca 
\adicionarMembro{\posto{MAJ}}{Alan Delei Cielusinsky}{CBMSC}
