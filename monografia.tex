...
\mes{Agosto} % Mês da apresentação do Trabalho
\dia{7} % Dia da apresentação do Trabalho
...
\adicionarMembro{\posto{CAP} \corporacao{BM}}{Me. Wagner Alberto de Moraes}{CBMSC} %membro da banca 
...
\input{capitulos.tex}
%\input{Texto/Capitulos/01_metodologia.tex}
