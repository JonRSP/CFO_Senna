...
\section{Comportamento Térmico}
    ...
    \subsection{Análise Gráfica}
        ...
        \subsubsection{Fardamento \acrlong{MM}}
            ...
            \figura{scale=0.5}{grafico_temp_MM.png}{Gráfico da variação de temperatura por tempo do fardamento \acrshort{MM}}{fig:tempMM}{L}{do autor (2025)}
        ...
        \subsubsection{Fardamento \acrlong{MML}}
            ...
            \figura{scale=0.5}{grafico_temp_MML.png}{Gráfico da variação de temperatura por tempo do fardamento \acrshort{MML}}{fig:tempMML}{L}{do autor (2025)}
