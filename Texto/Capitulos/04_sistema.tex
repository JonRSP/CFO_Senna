...
\subsection{Dispositivo Sensitivo}
	...
	\figura{scale=0.4}{esquema_DS.jpg}{Diagrama de montagem dos dispositivos sensitivos}{fig:diagramaDS}{}{do autor (2025)}

	\figura{scale=0.2}{fotoSensor.jpeg}{Dispositivo sensitivo construído}{fig:fotoSensor}{}{do autor (2025)}
...
\section{Sistema para Coleta de Dados}
    ...
    \figura{scale=0.4}{sistema_diagrama.png}{Diagrama simplificado da arquitetura do sistema de coleta de dados de temperatura}{fig:diagramaSis}{}{do autor (2025)}
...
\section{Validação dos Dispositivos Sensitivos}
	...
	e Pesquisa do \acrshort{CBMSC}, os dispositivos sensitivos
	 ...
	 \figura{scale=0.37}{validacao_1.jpg}{Montagem do experimento em laboratório}{fig:experimento}{}{do autor (2025)}
    ...
    \figura{scale=0.5}{validacao_comparacao.png}{Comparação entre os valores obtidos pelos dispositivos construídos e sensores de referência}{fig:comparacao}{}{do autor (2025)}
	...
	\end{itemize}
        ...
        \figura{scale=0.5}{validacao_erro.png}{Histogramas de distribuição de erros}{fig:erro}{L}{do autor (2025)}
